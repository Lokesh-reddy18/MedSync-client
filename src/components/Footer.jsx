...
const Footer = () => {
      return (
            <div className='md:mx-10'>
                  <div className='flex flex-col sm:grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-10 my-10 text-sm'>
                        <div>
                              ...
                              <p className='w-full md:w-2/3 mx-auto text-gray-600 leading-6 sm:text-left'>
                                    MedSync is committed to excellence in healthcare technology, we continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether you are booking your appointment or managing ongoing care, MedSync is here to support you every step of the way.
                              </p>
                        </div>
                        ...
                        <div>
                              ...
                              <ul className='flex flex-col gap-2 text-gray-600 cursor-pointer'>
                                    ...
                                    <li className="flex items-center gap-2">
                                          ...
                                          <a href="mailto:medsync@gmail.com" title="My Gmail account" aria-label="Gmail icon" className="text-gray-900 hover:text-black">
                                                medsync@gmail.com
                                          </a>
                                    </li>
                                    <li className="flex items-center gap-2">
                        ...
                        <div>
                              ...
                              <ul className='flex flex-col gap-2 text-gray-600 cursor-pointer'>
                                    <li className="flex gap-2 justify-start">
                                          <a href="https://github.com" title="Connect to Github" aria-label="Github icon" className="text-gray-600 hover:text-black">
                                                <AiFillGithub size={20} />
                                          </a>
                                          <a href="https://x.com" title="My personal Twitter account" aria-label="Twitter icon" className="text-gray-600 hover:text-black">
                                                <AiOutlineTwitter size={20} />
                                          </a>
                                          <a href="https://www.linkedin.com" title="My LinkedIn account" aria-label="LinkedIn icon" className="text-gray-600 hover:text-black">
                  ...
                  <div>
                        <hr />
                        <p className='py-5 text-sm text-center'>Copyright 2025@ MedSync - All Rights Reserved.</p>
                  </div>
            </div>
      )
}
